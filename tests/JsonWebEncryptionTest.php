...
PPK;
    ...
    public function testCreate(){
        ...
        $key2 = RSAJWKFactory::build(new RSAJWKPEMPrivateKeySpecification(self::$private_key_pem, JSONWebSignatureAndEncryptionAlgorithms::RSA1_5, JSONWebKeyPublicKeyUseValues::Encryption));
        ...
        $jwe     = JWEFactory::build($key2, new  StringOrURI(JSONWebSignatureAndEncryptionAlgorithms::A256CBC_HS512), JWSPayloadFactory::build($payload));
