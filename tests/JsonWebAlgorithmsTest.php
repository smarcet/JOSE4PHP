...
final class JsonWebAlgorithmsTest extends PHPUnit_Framework_TestCase {
    ...
    public function testAES_128_CBC_HMAC_SHA_256(){
        ...
        $key = ByteUtil::convertHalfWordArrayToBin( array(
        ...
        $plain_text  = ByteUtil::convertHalfWordArrayToBin( array (
        ...
        $iv = ByteUtil::convertHalfWordArrayToBin( array(
            0x1a, 0xf3, 0x8c, 0x2d, 0xc2, 0xb9, 0x6f, 0xfd, 0xd8, 0x66, 0x94, 0x09, 0x23, 0x41, 0xbc, 0x04
         ));

        $aad = ByteUtil::convertHalfWordArrayToBin(array(
        ...
        $cypher_text_should =  ByteUtil::convertHalfWordArrayToBin( array(
        ...
        $tag_should =  ByteUtil::convertHalfWordArrayToBin(array(0x65, 0x2c, 0x3f, 0xa3 ,0x6b, 0x0a, 0x7c, 0x5b, 0x32, 0x19 , 0xfa, 0xb3, 0xa3, 0x0b, 0xc1, 0xc4));
    ...
    public function testAES_192_CBC_HMAC_SHA_384(){
        ...
        $tag_should =  ByteUtil::convertHalfWordArrayToBin( array(
