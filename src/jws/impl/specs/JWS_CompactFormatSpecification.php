 ...
 **/
use jws\IJWS_CompactFormatSpecification;
/**
 * Class JWS_CompactFormatSpecification
 * @package jws\impl\specs
 */
final class JWS_CompactFormatSpecification
    implements IJWS_CompactFormatSpecification {
